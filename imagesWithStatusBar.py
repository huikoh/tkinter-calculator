...
my_img5 = ImageTk.PhotoImage(Image.open("5.png"))

image_list = [my_img1,my_img2,my_img3,my_img4,my_img5]

status = Label(root, text="Image of 1 of " + str(len(image_list)),bd=1,relief=SUNKEN,anchor=E)
...
def forward(image_number):
    ...
    # Uodate Status Bar
    status = Label(root, text="Image of "+ str(image_number) +" of " + str(len(image_list)),bd=1,relief=SUNKEN,anchor=E)
